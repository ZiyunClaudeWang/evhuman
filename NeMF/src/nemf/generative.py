...
class Architecture(BaseModel):
    ...
    def decode(self, z_l, z_g, length, step=1, decode_ts=None):
        b_size = z_l.shape[0]
        ...
        output['local_rotmat'] = local_rotmat
        ...
        if self.args.output_trans:
            ...
            output['global_pos'] = pos

            # at this step, the translation is with respect to the root height, and defined in a coordinate system where z is pointing up.
